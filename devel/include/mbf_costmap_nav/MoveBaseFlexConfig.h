...
namespace mbf_costmap_nav
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(MoveBaseFlexConfig &config, const MoveBaseFlexConfig &max, const MoveBaseFlexConfig &min) const
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const MoveBaseFlexConfig &config1, const MoveBaseFlexConfig &config2) const
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, MoveBaseFlexConfig &config) const
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const MoveBaseFlexConfig &config) const
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, MoveBaseFlexConfig &config) const
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const MoveBaseFlexConfig &config) const
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const MoveBaseFlexConfig &config, boost::any &val) const
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, MoveBaseFlexConfig &top) const
      {
        PT* config = boost::any_cast<PT*>(cfg);
