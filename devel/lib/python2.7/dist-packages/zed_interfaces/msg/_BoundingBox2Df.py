...
"""autogenerated by genpy from zed_interfaces/BoundingBox2Df.msg. Do not edit."""
import codecs
import sys
...
class BoundingBox2Df(genpy.Message):
  _md5sum = "8ce1e9ea2b267e0dce506c975b1391b0"
  _type = "zed_interfaces/BoundingBox2Df"
...
"""
  __slots__ = ['corners']
  _slot_types = ['zed_interfaces/Keypoint2Df[4]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BoundingBox2Df, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.corners is None:
        self.corners = [zed_interfaces.msg.Keypoint2Df() for _ in range(4)]
    else:
      self.corners = [zed_interfaces.msg.Keypoint2Df() for _ in range(4)]
